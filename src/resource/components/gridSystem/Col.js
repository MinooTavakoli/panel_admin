...
function Col({
    ...
    return (
        <div
            className={`col-${span} ${xs && `col-xs-${xs} `}${sm && `col-sm-${sm} `}${md && `col-md-${md} `
                }${lg && `col-lg-${lg} `}${xl && `col-xl-${xl} `}${xsHidden && `col-xs-hidden `
                }${smHidden && `col-sm-hidden `}${mdHidden && `col-md-hidden `}${lgHidden && `col-lg-hidden `
                }${xlHidden && `col-xl-hidden `}${smDownHidden && `col-sm-down-hidden `}${mdDownHidden && `col-md-down-hidden `
                }${lgDownHidden && `col-lg-down-hidden `}${xlDownHidden && `col-xl-down-hidden `
